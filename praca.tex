...
\titlePL{Dwuelementowa aplikacja sterowania czasooptymalnego w systemie zbiorników}
\titleEN{A two-element application of time-optimal control in a system of tanks}
...
\include{wstep}
\include{rozdz1model}
\include{rozdz2czasooptymalny}
\include{rozdz3lqr}
\include{rozdz4symulacja}
\include{rozdz5eksperyment}
\include{zakonczenie}
%\include{rozdzial3}
%\include{rozdzial1}
%\include{rozdzial2}
