...
Dalsze poszukiwania oprogramowania do optymalizacji dynamicznej przyniosły odkrycie pakietu Modelica. Jest to obiektowy język opisu dynamiki układów fizycznych oparty na definicji równań i matematycznych zależności między nimi (za: \cite{ModelicaWebsite}). Zawiera on narzędzia służące do przedstawiania w formie testowej i graficznej m.in układów:
\begin{itemize}
    \item mechanicznych,
    \item elektrycznych,
...
%TODO: opisać JModelicę
\cite{JModelicaUserGuide} \cite{JModelicaWebsite}
