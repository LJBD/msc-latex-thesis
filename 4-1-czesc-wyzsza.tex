...
\begin{itemize}
    ...
    \item biblioteki w językach C++ i Java zawierającej implementacje metod optymalizacji dynamicznej (używana jest tu metoda kolokacji bezpośredniej),
    \item API do języka Python mającego dostęp do wszystkich pozostałych komponentów.
\end{itemize}
